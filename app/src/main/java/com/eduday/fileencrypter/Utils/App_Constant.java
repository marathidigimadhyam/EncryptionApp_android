...
public class App_Constant  {
    public static String encryptionkey = "ZKMAsKSpxnC#@n@Kya@//QXCDSY6FuiO";
    public static String videoencryptionkey = "cRfUjXnZr4u7x!A%D*G-$@#EbCSaYp3s";
    public static String externalSDCard = "";
    public static Uri uri = null;
    public static String foldername = "MDM";
    public static String StorageFolderLocation = "MDM-Encrypt";
    ...
    public static String convertToStringRepresentation(long size){
        String hrSize = "";
        final String[] units = new String[] { "B", "KB", "MB", "GB", "TB" };
        int digitGroups = (int) (Math.log10(size) / Math.log10(1024));
        hrSize =  new DecimalFormat("#,##0.#").format(size / Math.pow(1024, digitGroups)) + " " + units[digitGroups];
        return hrSize;
    }
